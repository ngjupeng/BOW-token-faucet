...
function App() {
  const { networkId } = useContext(FaucetContext);
    ...
    <div className="min-w-screen min-h-screen bg-main h-auto pb-10 md:pb-0">
      {networkId == 4 ? (
        ...
        <div className="translate-y-1/2">
          <div className="text-center flex items-center justify-center shadow-xl max-w-[450px] h-[200px] bg-[#191b1fc2] mx-auto rounded-xl p-4 text-white text-xl">
